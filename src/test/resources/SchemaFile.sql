...
use inventorydb;
CREATE TABLE items (item_id INT NOT NULL auto_increment, item_name varchar(200) not null,price dec(3,2) not null,category varchar(100) not null,primary key (item_id));
